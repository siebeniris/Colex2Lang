...
class Dataset():
    def __init__(self, clusters):
        self.train_x = pd.read_csv('data/TypPred/train_x.csv')
        self.train_y = pd.read_csv('data/TypPred/train_y.csv')
        self.dev_x = pd.read_csv('data/TypPred/dev_x.csv')
        self.dev_y = pd.read_csv('data/TypPred/dev_y.csv')

        self.test_x = pd.read_csv('data/TypPred/test_x.csv')
